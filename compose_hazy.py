...
if __name__ == '__main__':
	...
	for i in range(length):
		...
		for rand in range(haze_num):
			...
			fog_density = round(random.uniform(0.5, 1.7), 2)
			...
			t_path = path + str(i) + 'b=' + '%.02f' % fog_density + '.npy'
			image_path = path + str(i) + '_a=[' + '%.02f' % fog_A_R + ',' + '%.02f' % fog_A_G + ',' + '%.02f' % fog_A_B + ']_b=' + '%.02f' % fog_density + '.png'
